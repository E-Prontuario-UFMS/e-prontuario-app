        ...
        <v-stepper-content step="2">
          <v-card class="mb-12">
            ...
            >
                                  ...
                                  <v-col cols="12">
                                    <v-container fluid>
                                      <v-switch
                                        class="float-md-left"
                                        v-model="
                                          editedItem.isItemDocumentoObrigatorio
                                        "
                                        color="success"
              ...
              <template v-slot:item.isItemDocumentoObrigatorio="{ item }">
                {{ item.isItemDocumentoObrigatorio ? "Sim" : "Não" }}
              </template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      incrementQuantity() {
        this.editedItem.qtdMaximaRegistros =
          this.editedItem.qtdMaximaRegistros + 1;
      },
      decrementQuantity() {
        this.editedItem.qtdMaximaRegistros =
          this.editedItem.qtdMaximaRegistros - 1;
